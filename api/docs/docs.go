...
const docTemplate = `{
                        ...
                        "schema": {
                            ...
                            "properties": {
                                "data": {
                                    "type": "array",
                                    "items": {
                                        "$ref": "#/definitions/model.CertificationFull"
                                    }
                                },
                                "meta": {
                                    "type": "object"
        ...
        "/v1/certifications": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Filter by country code (e.g. FR)",
                        "name": "country",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Filter by level (e.g. platinum)",
                        "name": "level",
                        "in": "query"
                    },
                    {
        ...
        "/v1/search": {
            "get": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "Search query (artist or release name)",
                        "name": "q",
                        "in": "query",
                        "required": true
                    },
    ...
    "definitions": {
        ...
        "model.CertificationFull": {
            "type": "object",
            "properties": {
                "artist": {
                    "$ref": "#/definitions/model.ArtistRef"
                },
                "certified_at": {
                    "type": "string"
                },
                ...
                "release": {
                    "$ref": "#/definitions/model.ReleaseRef"
                },
                "sales_equivalent": {
                    "type": "integer"
                },
